...
object ModelProvisioner {
     ...
     * treat "not downloaded" as an ordinary failure - captures still record and wait in
     * the pending folder, and are transcribed on a later retry once the download lands.
     */
