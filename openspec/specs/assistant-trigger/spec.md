...
Register EasyNote as the system's digital assistant so that a power-button hold starts a voice capture session, and hand off to the capture session without rendering any UI.
